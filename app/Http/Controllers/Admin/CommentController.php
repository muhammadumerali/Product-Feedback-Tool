...
class CommentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.comments.index', compact('comments', 'feedbacks', 'users'));
    }
    ...
    public function create()
    {
        ...
        $feedback = Feedback::pluck('title', 'id')->prepend(trans('global.pleaseSelect'), '');

        return view('admin.comments.create', compact('feedback', 'users'));
    }
    ...
    public function edit(Comment $comment)
    {
        ...
        return view('admin.comments.edit', compact('comment', 'feedback', 'users'));
    }
